---
name: onboarding
description: First-run setup walkthrough for a new career-ops user -- CV, profile, portals, tracker, and getting-to-know-you steps. Use when doctor.mjs reports onboardingNeeded=true.
---

# Onboarding

Run when `node doctor.mjs --json` reports `onboardingNeeded: true`. Do NOT proceed with
evaluations, scans, or any other mode until the basics are in place.
